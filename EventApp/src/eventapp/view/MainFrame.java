...
public class MainFrame extends javax.swing.JFrame {
    ...
    public void notifyModel(DefaultTableModel model){
        for(Observer observer: observers){  
            observer.notifyModel(model);
        }
    }
            
    public void notifyAddEvent(Event event){
        for(Observer observer: observers){          
            observer.notifyAddEvent(event);
    ...
    public void notifyModifyEvent(Event oldEvent, Event newEvent){
        for(Observer observer: observers){
            observer.notifyModifyEvent(oldEvent, newEvent);
            jMenuItemUndo.setEnabled(true);
            jMenuItemRedo.setEnabled(false);
        }
    }
    ...
    public void notifyRemoveEvent(Event event){
        for(Observer observer: observers){
            observer.notifyRemoveEvent(event);
            jMenuItemUndo.setEnabled(true);
            jMenuItemRedo.setEnabled(false);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/eventapp/res/logoTeluq.png"))); // NOI18N
        ...
        jMenuItemOpen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/eventapp/res/open-folder.png"))); // NOI18N
        ...
        jMenuItemNew.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        ...
        jMenuItemUndo.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jMenuItemUndo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/eventapp/res/undo.png"))); // NOI18N
        jMenuItemUndo.setText("Annuler");
        ...
        jMenuItemRedo.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jMenuItemRedo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/eventapp/res/redo.png"))); // NOI18N
        jMenuItemRedo.setText("Refaire");
        ...
        jMenuItemModify.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_M, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        jMenuItemModify.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jMenuItemModify.setText("Modifier");
        jMenuItemModify.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemModifyActionPerformed(evt);
            }
        });
        jMenuEdit.add(jMenuItemModify);

        jMenuItemRemove.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_DELETE, 0));
        jMenuItemRemove.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jMenuItemRemove.setIcon(new javax.swing.ImageIcon(getClass().getResource("/eventapp/res/bin.png"))); // NOI18N
        jMenuItemRemove.setText("Supprimer");
    ...
    private void jButtonAddAcceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddAcceptActionPerformed
        ...
        if (strTitle.isEmpty() || strPubDate.isEmpty() || strLink.isEmpty() || strGuid.isEmpty() || strDescription.isEmpty()){
            ...
            // Create an event and notify observer
            Event newEvent = new Event(strTitle, strLink, strGuid, strPubDate, strDescription);
            if (isAdding) { 
                this.notifyAddEvent(newEvent);
                isAdding = false;
            } else {       
                Event oldEvent = this.notifyGetEvent(tableEvents.getSelectedRow());
                this.notifyModifyEvent(oldEvent,newEvent);
            }
;
